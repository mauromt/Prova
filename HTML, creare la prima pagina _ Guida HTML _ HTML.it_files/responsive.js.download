 ...
 * Build: http://modernizr.com/download/#-backgroundsize-inlinesvg-svg-svgclippaths-touch-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes-load */ 
...
// responsive videos and tables

$(function() {
   $('.content-text iframe, .content-text embed, .content-text object').wrap('<div class="flex-video-container"></div>');
   $('.content-text table').wrap('<div class="table-overflow-container"></div>');
}); 
